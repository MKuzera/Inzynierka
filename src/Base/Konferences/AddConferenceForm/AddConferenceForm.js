...
const AddConferenceForm = ({ onAddConference, onCancel }) => {
    ...
    const handleSubmit = (e) => {
        ...
        const conference = {
            ...
            description,
            location,
            organizers: organizers.split(',').map(item => item.trim()),
    ...
    return (
        <form onSubmit={handleSubmit} className="add-conference-form">
            ...
            <label>Organizatorzy (oddzielone przecinkami):</label>
            <input type="text" value={organizers} onChange={(e) => setOrganizers(e.target.value)} required />
